...
local tMenuItems = {"Save", "Exit", "Print", "GoTo", "Find", "Next", "Previous"}
...
local tMenuFuncs = { 
 ...
 Find=function()
  ...
  term.write("Enter phrase you wish to find: ")
  ...
  for phrasey = 1, #tLines do


    if string.find(tLines[phrasey], phrase) then


      phrasex,useless = string.find(tLines[phrasey], phrase)


      tempnum = tempnum + 1


      Yphrase[tempnum] =  phrasey


      Xphrase[tempnum] = phrasex
  ...
  if Yphrase[z] ~= nil and Xphrase[z] ~= nil then
